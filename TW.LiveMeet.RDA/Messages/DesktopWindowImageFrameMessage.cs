...
{
    public class DesktopWindowImageFrameMessage : RdapMessageBase, IRdapMessage
    {
        ...
        public DesktopWindowImageFrameMessage(byte[] messageBuffer)
            : base(messageBuffer)
        {
            InitialiseFieldPositions();
        }

        public DesktopWindowImageFrameMessage(RdapImagePixelFormatType formatType, uint width, uint height, byte[] imageBytes)
        {
