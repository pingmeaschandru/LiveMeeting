...
{
    public class DesktopWindowInfoMessage : RdapMessageBase, IRdapMessage
    {
        ...
        public DesktopWindowInfoMessage(byte[] messageBuffer)
            : base(messageBuffer)
        {
            InitialiseFieldPositions();
        }

        public DesktopWindowInfoMessage(RdapImagePixelFormatType formatType, uint width, uint height, byte[] imageBytes)
        {
